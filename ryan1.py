...
\033[1;32m d8888b. db    db  .d8b.  d8b   db 
\033[1;32m 88  `8D `8b  d8' d8' `8b 888o  88 
\033[1;32m 88oobY'  `8bd8'  88ooo88 88V8o 88 
\033[1;32m 88`8b      88    88~~~88 88 V8o88 
\033[1;32m 88 `88.    88    88   88 88  V888 
\033[1;32m 88   YD    YP    YP   YP VP   V8P

\033[1;33m------------------------------------------------
\033[1;32m Owner   :            Aung Phyo Thant
\033[1;34m Facebook:            Aung Phyo Thant
\033[1;31m Github  :            Ryan
\033[1;32m Version :            ★ Premium ★
\033[1;33m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
def method_crack():
    ...
    print(f'\033[1;32m[2] Method {2}')
    print(f'\033[1;32m[3] Method {3}')
    print(f'\033[1;32m[4] Method {4}')
    print(f'\033[1;32m[0] Back')
    print('')
